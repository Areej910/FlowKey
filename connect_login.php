      ...
      <div class="form-container">
        ...
        <div class="form-inner">
          ...
          <form action="signup.php" class="signup" method="POST">
            ...
            <div class="field">
              <input type="password" placeholder="Confirm password" id="conpassword" name="Confirm password" pattern="" 
              title="Passwords do not match" required>
            </div>
            <div class="field btn">
              <div class="btn-layer"></div>
...
<p><a href="FlowKey.html">Back To The Website</a></p>
